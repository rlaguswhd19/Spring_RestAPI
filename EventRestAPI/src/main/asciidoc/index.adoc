...
operation::query-events[snippets='http-request,curl-request,http-response,request-body,response-body']
...
operation::get-an-event[snippets='http-request,curl-request,http-response,request-body,response-body']
